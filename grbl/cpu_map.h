...
#define cpu_map_h
  ...
  #define SPINDLE_DIRECTION_BIT   3 // MEGA2560 Digital Pin 5
	  ...
	  #define SPI_DONE_MASK 0x80
	  #define SPI_DATA SPDR
  	  #define SPI_CTRL SPCR
	  #define SPI_DDR DDRB
	  #define SPI_PORT PORTB
	  #define SPI_SS_BIT 0 // MEGA Pin 53 - PB0
	  #define SPI_MOSI_BIT 2 // MEGA Pin 51 - PB2
 	  #define SPI_MISO_BIT 3 // MEGA Pin 50 - PB3
	  #define SPI_SCK_BIT 1 // MEGA Pin 52 - PB1
  #endif
